...
if __name__ == "__main__":
    ...
    mahsa = os.listdir("./Data/Exp2")
    
    # get_image_file = lambda n : '{}/{}'.format('./Huawei_I', n)

    get_weak_file = lambda n : 'Data/Exp2/{}/{}'.format(n, 't_output.png')


    get_image_file = lambda n : 'Data/Exp2/{}/{}'.format(n, 'input.png')
...
pretrained = 'places365',   
                    ...
                    show_every=500, plot_every=5000, 
                    outdir = './Output/',
                    outdir_name = 'Exp2_1_1{}'.format("vggLoss"))
...
"""
2_1 --- 2     ****** run again as 2_1 --- 4 but with changes in weights
pretrained = 'places365',   
                    input_type = 'image',
                    enable_cross = True, #True,
                    enable_feedback = True, # True,
                    ...
                    show_every=500, plot_every=5000, 
                    outdir = './Output/',
                    outdir_name = 'Exp2_1_2{}'.format("vggLoss"))
