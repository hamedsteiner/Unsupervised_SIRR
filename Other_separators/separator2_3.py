...
if __name__ == "__main__":
    ...
    mahsa = os.listdir("./Data/Exp3")
    
    # get_image_file = lambda n : '{}/{}'.format('./Huawei_I', n)

    get_weak_file = lambda n : 'Data/Exp3/{}/{}'.format(n, 't_output.png')


    get_image_file = lambda n : 'Data/Exp3/{}/{}'.format(n, 'input.png')
    ...
    for alpha_val in alpha_vals:
        ...
        for idx, name in enumerate(mahsa):
            ...
            model3 = Separator(
                    ...
                    outdir_name = 'Exp2_3_3{}'.format("_WithExp3Images_With_InitXavier"))
...
pretrained = 'places365',   
                    ...
                    show_every=500, plot_every=5000, 
                    outdir = './Output/',
                    outdir_name = 'Exp2_3_1{}'.format("vggLoss_weak"))
