...
# local 
from net.percep_model3_skip3 import *
...
if __name__ == "__main__":
    ...
    get_weak_file = lambda n : 'Data/Exp3_SIR/{}/{}'.format(n, 'input.png')
    ...
    for alpha_val in alpha_vals:
        ...
        for idx, name in enumerate(mahsa):
            ...
            model3 = Separator(
                    ...
                    outdir_name = 'Exp3_3_2_noweak{}'.format(""))
