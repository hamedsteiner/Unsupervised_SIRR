...
if __name__ == "__main__":
    ...
    # mahsa = os.listdir("./Data/SamplesFromHuawei_ERR")
    mahsa = os.listdir("./Data/ERR_SIR")
    
    # get_image_file = lambda n : '{}/{}'.format('./Huawei_I', n)

    get_weak_file = lambda n : 'Data/SamplestoTest/{}/{}'.format(n, 't_output.png')
    # get_weak_file = lambda n : 'Data/SamplesFromHuawei_ERR/{}/{}'.format(n, 'errnet.png')


    # get_image_file = lambda n : 'Data/SamplesFromHuawei_ERR/{}/{}'.format(n, 'm_input.png')
    get_image_file = lambda n : 'Data/ERR_SIR/{}/{}'.format(n, 'm_input.png')
    # get_image_file = lambda n : 'Data/exp_zibayi_all/{}/{}'.format(n, 'input.png')
...
#    get_image_gt_r_file = lambda n :'{}/R/{}_r.jpg'.format(image_dir, n)
    ...
    n_iters = [5500]
    enable_alphas = [1]
    ssim_weights = [0.0, 0.11]

    # weak_weight = 0.55
    # vgg_weight = 0.1

    # weak_weights = [0.0, 0.25, 0.5]
    # vgg_weights = [0.0, 0.1, 0.25]
    ...
    for weak_weight in weak_weights:
        for vgg_weight in vgg_weights:
            ...
            for enable_alphaa in enable_alphas:
                    ...
                    for alpha_val in alpha_vals:
                        ...
                        for idx, name in enumerate(mahsa):
                            ...
                            model3 = Separator(
                                    ...
                                    tvex_loss_weight  = 0.003, 
                                    # weak_weight = 0.15, #0.55,
                                    weak_weight = weak_weight, #0.01,
                                    vgg_weight = vgg_weight,#was 0.05
                                    # vgg_weight = 0.2,

                                    # training parameters ------- 
                                    num_iter=n_iter, learning_rate=0.0001,#0.0001 
                                    show_every=600, plot_every=5000, 
                                    outdir = './Output/',
                                    
                                    # outdir_name = 'ALL_SIR_Dialated_BjozGhablia{}'.format(alpha_val))
                                    # outdir_name = 'kaggle_images2{}'.format(alpha_val))
                                    # outdir_name = 'Exp3_5_FinalTest1_noSSIM_L1Weak{}'.format(alpha_val))
                                    outdir_name = 'Exp3_5_SIR_weaks_{}_vgg_{}_{}_'.format(weak_weight, vgg_weight, enable_alphas))
...
"""
                        ...
                        # outdir_name = 'ALL_SIR_Dialated_BjozGhablia{}'.format(alpha_val))
                        # outdir_name = 'kaggle_images2{}'.format(alpha_val))
                        outdir_name = 'Exp3_5_FinalTest1_noSSIM_{}'.format(alpha_val))
                        #  outdir_name = 'H3{}'.format(alpha_val))
                model3.run(num_run=2)
                del model3
...
recon_loss_weight = 1.5, 
                            ...
                            tvex_loss_weight  = 0.001, 
                            # weak_weight = 0.15, #0.55,
                            weak_weight = 0.01, #0.55,
                            vgg_weight = 0.05,
                            # vgg_weight = 0.2,

                            # training parameters ------- 
                            num_iter=n_iter, learning_rate=0.0001,#0.0001 
                            show_every=300, plot_every=5000, 
                            outdir = './Output/',
                            
                            # outdir_name = 'ALL_SIR_Dialated_BjozGhablia{}'.format(alpha_val))
                            # outdir_name = 'kaggle_images2{}'.format(alpha_val))
                            # outdir_name = 'Exp3_5_FinalTest1_noSSIM_L1Weak{}'.format(alpha_val))
                            outdir_name = 'Exp3_5_Final__alphaenable_{}_SSIM0'.format(enable_alphas))
