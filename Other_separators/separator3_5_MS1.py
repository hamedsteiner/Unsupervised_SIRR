...
if __name__ == "__main__":
    ...
    mahsa = os.listdir("./Data/Brek_ASL")
    
    # get_image_file = lambda n : '{}/{}'.format('./Huawei_I', n)

    get_weak_file = lambda n : 'Data/Brek_ASL/{}/{}'.format(n, 'errnet.png')


    get_image_file = lambda n : 'Data/Brek_ASL/{}/{}'.format(n, 'm_input.png')
...
#    get_image_gt_r_file = lambda n :'{}/R/{}_r.jpg'.format(image_dir, n)
    ...
    # vgg_weights = [0.03, 0.25, 0.5]
    # vgg_weights = [0.20, 0.45]
    vgg_weights = [0.0]

    alpha_val = alpha_vals[0]
            ...
            for cur_ssim_weight in ssim_weights: 
                for idx, name in enumerate(mahsa):
                    ...
                    model3 = Separator(
                            ...
                            # outdir_name = 'Exp3_5_SamplesFromHuawei_ERR_testerideman_ssim008_WeakL1Loss{}'.format(alpha_val))

                            
                            outdir_name = 'Exp3_5_FinalTest_Brek_VGG_{}_SSIM_{}_{}'.format(vgg_weight, cur_ssim_weight, alpha_val))
...
"""
              ...
              recon_loss_weight = 1.5, 
                        ...
                        # outdir_name = 'ALL_SIR_Dialated_BjozGhablia{}'.format(alpha_val))
                        # outdir_name = 'kaggle_images2{}'.format(alpha_val))
                        outdir_name = 'Exp3_5_SamplesFromHuawei_ERR_testerideman_ssim1{}'.format(alpha_val)
                        """
...
recon_loss_weight = 1.5, 
                        ...
                        outdir_name = 'Exp3_5_FinalTest_Brek_SSIM01_{}'.format(alpha_val))
