...
class Separator:
    def __init__(self, folder_name, image_file, 
        ...
        # --Type definition--
        self.LOSSES = namedtuple('LOSSES', ['loss', 'recon', 'gray', 'cross', 'excld','smooth', 'ceil', 'weak', 'tvex'])
...
if __name__ == "__main__":
    ...
    mahsa = os.listdir("./Data/Exp1")
    
    # get_image_file = lambda n : '{}/{}'.format('./Huawei_I', n)

    get_weak_file = lambda n : 'Data/Exp1/{}/{}'.format(n, 't_output.png')


    get_image_file = lambda n : 'Data/Exp1/{}/{}'.format(n, 'input.png')
    ...
    for alpha_val in alpha_vals:
        ...
        for idx, name in enumerate(mahsa):
            ...
            model3 = Separator(
                    ...
                    # training parameters ------- 
                    num_iter=5000, learning_rate=0.0001,#0.0001 
                    ...
                    outdir_name = 'Exp1_{}'.format("try2____5000iter"))
