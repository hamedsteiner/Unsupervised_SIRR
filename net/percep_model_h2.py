...
class PercepNet(nn.Module): 
    def __init__(self, n_channels, n_classes, image_t,  pretrained='places365',enable_attn=False): 
        ...
        self.Up1 = up(128, 128)
        self.Up2 = up(384, 128)     #change
        self.Up3 = up(128, 64)      #change           
        self.Up4 = up(64, 64)  #224 
        self.Up5 = up(64, 64)  #224               
        self.output = outconv(64, n_classes)  #224
    ...
    def dec(self, x): 
        ...
        # y1 = self.decoder(x)
        # y2 = self.Up1(torch.cat([y1, self.feats[0].detach()], dim=1))
        # y3 = self.Up2(y2)
        
        y1 = self.Up1(x)
        y2 = self.Up2(torch.cat([y1, self.feats[2].detach()], dim=1))
        y3 = self.Up3(y2)
    ...
    def forward(self, x):
        ...
        # print("alat ",len(self.feats))
        # print("duuuuf ",(self.feats[0].shape))
        # print("duuuuf1 ",(self.feats[1].shape))
        # print("duuuuf2 ",(self.feats[2].shape))
        # print("duuuuf3 ",(self.feats[3].shape))
        # exit()
