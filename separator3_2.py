...
# local 
from net.percep_model3_skip2 import *
...
if __name__ == "__main__":
    images = os.listdir("./Data/ERR_SIR")
                ...
                for alpha_val in alpha_vals:
                    ...
                    for idx, name in enumerate(images):
                        ...
                        model3 = Separator(
                                ...
                                # training parameters ------- 
                                num_iter=5500, learning_rate=0.0001,#0.0001 
                                show_every=500, plot_every=5000, 
                                outdir = './Output/',

                                outdir_name = 'Exp3_2_SIR_weak_{}_vgg_{}_alpha_{}'.format(weak_weight, vgg_weight, alpha_val))
